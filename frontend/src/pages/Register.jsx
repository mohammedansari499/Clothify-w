...
export default function Register() {
  ...
  return (
    <div className="flex-1 flex items-center justify-center px-4 py-20 bg-darker relative overflow-hidden">
      ...
      <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-primary/20 rounded-full blur-[120px] -z-10 animate-pulse-slow" />
      <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-primary/10 rounded-full blur-[120px] -z-10 animate-pulse-slow" style={{ animationDelay: '2s' }} />
      ...
      <div className="w-full max-w-md bg-card/40 backdrop-blur-2xl p-10 rounded-[2rem] border border-border-subtle shadow-2xl relative overflow-hidden group">
        <div className="absolute -top-24 -left-24 w-48 h-48 bg-primary/20 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
        ...
        <div className="relative z-10">
          ...
          <h2 className="text-4xl font-black mb-3 tracking-tighter text-text">Create Account</h2>
          <p className="text-text-muted mb-10 font-medium">Start your AI wardrobe journey today.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-[10px] text-text-muted/60 mt-2 ml-1">Must be at least 8 characters long.</p>
            </div>
          ...
          {hasGoogleAuth && (
            <>
              <div className="mt-10 flex items-center gap-4">
                ...
                <span className="text-[10px] font-black text-text-muted/50 uppercase tracking-[0.2em]">or sign up with</span>
                <div className="flex-1 h-px bg-border-subtle" />
              </div>
          ...
          {!hasGoogleAuth && (
            <div className="mt-6 text-xs text-text-muted/70">
              Google sign-up is disabled until <code>VITE_GOOGLE_CLIENT_ID</code> is set.
            </div>
          )}
