            ...
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="flex flex-col items-center gap-2">
                <motion.div
                  ...
                  className={`w-8 h-8 text-sm rounded-full flex items-center justify-center font-black transition-all border-2 ${step >= i ? 'border-primary shadow-[0_0_20px_rgba(var(--primary-rgb),0.4)]' : 'border-border-subtle'
                    }`}
                >
                ...
                <div className="pt-8 space-y-4">
                  <div className="flex gap-4">
                    ...
                    <motion.button
                      ...
                      disabled={loading}
                      className="flex-[2] py-3.5 bg-primary text-darker font-black text-lg rounded-2xl hover:bg-primary-hover shadow-xl shadow-primary/40 flex items-center justify-center gap-2"
                    >
