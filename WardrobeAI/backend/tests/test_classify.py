...
class TestExtractColors:
    ...
    def test_extract_from_valid_image(self):
        """Valid image path returns list of 3 RGB colors."""
        from app.services.classifier_service import extract_colors
    ...
    def test_extract_from_nonexistent_file(self):
        """Nonexistent image path raises an error."""
        from app.services.classifier_service import extract_colors

        assert extract_colors("/nonexistent/path.jpg") == [[128, 128, 128]]


@pytest.mark.unit
class TestClassifyClothing:
    """classify_clothing() — random label classifier (placeholder)."""

    def test_returns_valid_label(self):
        """Returns one of the known clothing labels."""
        from app.services.classifier_service import classify_clothing
        ...
        result = classify_clothing("any_path.jpg")
    ...
    def test_returns_dict(self):
        ...
        result = classify_clothing("test.jpg")
...
class TestAnalyzeClothing:
    ...
    @patch("app.services.classifier_service.classify_clothing",
    ...
    @patch("app.services.classifier_service.extract_colors",
           return_value=[[200, 50, 50], [100, 100, 100], [50, 50, 200]])
...
class TestClassifyEndpoint:
    ...
    @patch("app.services.classifier_service.analyze_clothing")
